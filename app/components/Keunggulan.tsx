...
export default function Keunggulan() {
  return (
    <section className="bg-gray-50 px-5 pt-5 pb-0">
      <h2 className="text-xl font-bold text-gray-800 mb-4">Mengapa Memilih Kami?</h2>
      <div className="grid grid-cols-2 gap-3">
        {keunggulan.map(({ icon: Icon, title, desc }) => (
          <div
            key={title}
            className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col gap-2 transition hover:shadow-md hover:-translate-y-0.5"
          >
